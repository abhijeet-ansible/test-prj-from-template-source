...
---
{
    ...
    */
    "APP:SERVICE_UNAVAILABLE4": {
        code: 503,
        reason: "Service Unavailable Custom Error.. ",
        message: error.description ++ error.errorType.namespace ++ ":" ++ error.errorType.identifier 
    },
    ...
    */
    "HTTP:INTERNAL_SERVER_ERROR": {
        code: 500,
        reason: "Internal Server Custom Error...",
    ...
    */
    ...
    "MULE:EXPRESSION": {
        code: 500,
        reason:  "Mule Expression Error, Possibly a Dataweave Issue. Please see logs for detailed issue" ,
        message: "Message *****"
    },
    ...
    "APP:NOT_FOUND" : {
    	code: 404,
        reason:  "Mule 404.." ,
        message: "Resource Not Found" ++ " "++ attributes.requestUri
    }
}